...
/***/ function(module, exports, __webpack_require__) {
	...
	var GeoSpatialChart = _react2.default.createClass({
	  ...
	  renderChart: function renderChart(width, height) {
	    var self = this;
	    var projection = d3.geo.mercator().center([0, 5]).scale(150).rotate([-180, 0]);
	    ...
	    // create tooltip
	    var tooltip = d3.select(svgdom).append('div').attr('class', 'hidden tooltip');
	    ...
	    d3.json('world.json', function (error, topology) {
	      ...
	      d3.csv('geo.csv', function (error, data) {
	        g.selectAll('circle').data(data).enter().append('a').attr('xlink:href', function (d) {
	          ...
	          tooltip.classed('hidden', false).attr('style', 'left:' + (mouse[0] + 15) + 'px; top:' + (mouse[1] + 55) + 'px').html(self.generateStats(d));
