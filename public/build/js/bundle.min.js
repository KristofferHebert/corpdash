...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(_reactRouter.Router, { routes: _router2.default, history: _reactRouter.hashHistory });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Routes = _react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.IndexRoute, { name: '/', component: _index2.default }),
	  _react2.default.createElement(_reactRouter.Route, { name: 'key-metrics', path: 'key-metrics', component: _index4.default }),
	  _react2.default.createElement(_reactRouter.Route, { name: 'all-data', path: 'all-data', component: _index6.default })
	);
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    _reactRouter.Link,
	                    { activeClassName: 'active', to: '/key-metrics' },
	                    'Key Metrics'
	                  )
	                ),
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    _reactRouter.Link,
	                    { activeClassName: 'active', to: '/all-data' },
	                    'All Data'
	                  )
	                )
	              )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _geospatial = __webpack_require__(8);

	var _geospatial2 = _interopRequireDefault(_geospatial);

	var _getdata = __webpack_require__(9);

	var _getdata2 = _interopRequireDefault(_getdata);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var GeoSpatialPage = _react2.default.createClass({
	  displayName: 'GeoSpatialPage',
	  render: function render() {
	    return _react2.default.createElement(
	      'section',
	      null,
	      ...
	      _react2.default.createElement(_geospatial2.default, { width: 960, height: 500 })
	    );
	  }
	});

	exports.default = GeoSpatialPage;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GeoSpatialChart = _react2.default.createClass({
	  displayName: 'GeoSpatialChart',
	  generateStats: function generateStats(data) {
	    return data.city + ',' + data.country + ' office <br />' + data.num + ' employees';
	  },
	  renderChart: function renderChart(width, height) {
	    var self = this;
	    var projection = d3.geo.mercator().center([0, 5]).scale(160).rotate([-180, 0]);

	    // create chart dom
	    var svgdom = this.refs.geo;
	    var svg = d3.select(svgdom).append('svg').attr('width', width).attr('height', height);

	    // create tooltip
	    var tooltip = d3.select(svgdom).append('div').attr('class', 'hide tooltip');
	    ...
	    d3.json('world.json', function (error, topology) {
	      ...
	      d3.csv('geo.csv', function (error, data) {
	        g.selectAll('circle').data(data).enter().append('a').append('circle').attr('cx', function (d) {
	          return projection([d.lon, d.lat])[0];
	        }).attr('cy', function (d) {
	          return projection([d.lon, d.lat])[1];
	        }).attr('r', 5).style('fill', 'blue').on('mousemove', function (d) {
	          var mouse = d3.mouse(svg.node()).map(function (d) {
	            return parseInt(d);
	          });
	          tooltip.classed('hide', false).attr('style', 'left:' + (mouse[0] + 15) + 'px; top:' + (mouse[1] + 55) + 'px').html(self.generateStats(d));
	  ...
	  render: function render() {
	    return _react2.default.createElement('section', { id: 'geo', ref: 'geo' });
	  }
	});

	exports.default = GeoSpatialChart;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function getData(url) {
	  ...
	  return (0, _makerequest2.default)(url, options);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _openissues = __webpack_require__(13);

	var _openissues2 = _interopRequireDefault(_openissues);
	...
	var _barchart = __webpack_require__(76);

	var _barchart2 = _interopRequireDefault(_barchart);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var KeyMetricsPage = _react2.default.createClass({
	  displayName: 'KeyMetricsPage',
	  ...
	  csvToCollection: function csvToCollection(csv) {
	    return csv.splice(1).map(function (r) {
	      return {
	        'id': r[0],
	        'customer_name': r[1],
	        'customer_email': r[2],
	  ...
	  getData: function getData(url) {
	    ...
	    (0, _makeRequest2.default)(url, options).then(function (response) {
	  ...
	  getBarData: function getBarData(url) {
	    var options = {
	      method: 'get'
	    };
	    var self = this;
	    ...
	    (0, _makeRequest2.default)(url, options).then(function (response) {
	      var barData = JSON.parse(response);
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(_openissues2.default, { data: this.state.data }),
	      _react2.default.createElement(_linechart2.default, null),
	      _react2.default.createElement(_barchart2.default, { barData: this.state.barData })
	    );
	  }
	});

	exports.default = KeyMetricsPage;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OpenIssues = _react2.default.createClass({
	  displayName: 'OpenIssues',
	  renderOpenIssuesNumber: function renderOpenIssuesNumber(data) {
	    var issues = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rd = __webpack_require__(16);
	...
	var LnChrt = _rd2.default.LineChart;
	...
	var LineChart = _react2.default.createClass({
	  ...
	  getLineChartData: function getLineChartData(url) {
	    ...
	    (0, _makeRequest2.default)(url, options).then(function (response) {
	      var lineData = JSON.parse(response);
	  ...
	  renderChart: function renderChart() {
	    if (this.state.lineData.length == 0) {
	      ...
	      return _react2.default.createElement(
	        'section',
	        null,
	        _react2.default.createElement(LnChrt, {
	          legend: true,
	          width: '100%',
	          height: 400,
	          viewBoxObject: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.BarChart = __webpack_require__(17).BarChart;
	exports.LineChart = __webpack_require__(44).LineChart;
	exports.PieChart = __webpack_require__(50).PieChart;
	exports.AreaChart = __webpack_require__(55).AreaChart;
	exports.Treemap = __webpack_require__(60).Treemap;
	exports.ScatterChart = __webpack_require__(65).ScatterChart;
	exports.CandlestickChart = __webpack_require__(70).CandlestickChart;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.BarChart = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataSeries = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var BarContainer = __webpack_require__(21);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bar = __webpack_require__(22);
	var shade = __webpack_require__(23).shade;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.XAxis = __webpack_require__(25).XAxis;
	exports.YAxis = __webpack_require__(25).YAxis;
	exports.Chart = __webpack_require__(31).Chart;
	exports.LegendChart = __webpack_require__(31).LegendChart;
	exports.Legend = __webpack_require__(35);
	exports.Tooltip = __webpack_require__(36);
	exports.Voronoi = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.XAxis = __webpack_require__(26);
	exports.YAxis = __webpack_require__(30);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var d3 = __webpack_require__(19);
	var AxisTicks = __webpack_require__(27);
	var AxisLine = __webpack_require__(28);
	var Label = __webpack_require__(29);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.BasicChart = __webpack_require__(32);
	exports.Chart = __webpack_require__(33);
	exports.LegendChart = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var LegendChart = __webpack_require__(34);
	var BasicChart = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CartesianChartPropsMixin = __webpack_require__(40);
	exports.DefaultAccessorsMixin = __webpack_require__(41);
	exports.ViewBoxMixin = __webpack_require__(42);
	exports.TooltipMixin = __webpack_require__(43);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.LineChart = __webpack_require__(45);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataSeries = __webpack_require__(46);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var d3 = __webpack_require__(19);
	var VoronoiCircleContainer = __webpack_require__(47);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shade = __webpack_require__(23).shade;
	var VoronoiCircle = __webpack_require__(48);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TooltipMixin = __webpack_require__(39).TooltipMixin;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var d3 = __webpack_require__(19);
	var ArcContainer = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.AreaChart = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var d3 = __webpack_require__(19);
	var DataSeries = __webpack_require__(57);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var d3 = __webpack_require__(19);
	var AreaContainer = __webpack_require__(58);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Treemap = __webpack_require__(61);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var d3 = __webpack_require__(19);
	var React = __webpack_require__(1);
	var Chart = __webpack_require__(24).Chart;
	var DataSeries = __webpack_require__(62);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var d3 = __webpack_require__(19);
	var CellContainer = __webpack_require__(63);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var shade = __webpack_require__(23).shade;
	var Cell = __webpack_require__(64);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ScatterChart = __webpack_require__(66);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataSeries = __webpack_require__(67);
	var utils = __webpack_require__(23);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var d3 = __webpack_require__(19);
	var VoronoiCircleContainer = __webpack_require__(68);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shade = __webpack_require__(23).shade;
	var VoronoiCircle = __webpack_require__(69);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CandlestickChart = __webpack_require__(71);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var d3 = __webpack_require__(19);
	var utils = __webpack_require__(23);
	var DataSeries = __webpack_require__(72);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var CandlestickContainer = __webpack_require__(73);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var utils = __webpack_require__(23);
	var Candle = __webpack_require__(74);
	var Wick = __webpack_require__(75);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BrChrt = _rd2.default.BarChart;
	...
	var BarChart = _react2.default.createClass({
	  ...
	  renderBarChart: function renderBarChart() {
	    ...
	    return _react2.default.createElement(BrChrt, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _datachart = __webpack_require__(78);
	...
	var AllDataPage = _react2.default.createClass({
	  displayName: 'AllDataPage',
	  componentWillMount: function componentWillMount() {
	    this.getData('data.csv');
	  },
	  ...
	  applySort: function applySort(sort, data) {
	    if (sort !== 'none') {
	      return _lodash2.default.sortBy(data, sort);
	    } else {
	      return data;
	    }
	  },
	  getInitialState: function getInitialState() {
	    return {
	      ...
	      nav: ['id', 'customer_name', 'customer_email', 'submission', 'description', 'open', 'closed', 'employee_name']
	    };
	  },
	  csvToCollection: function csvToCollection(csv) {
	    return csv.splice(1).map(function (r) {
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'section',
	      null,
	      _react2.default.createElement(_datachart2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DataChart = _react2.default.createClass({
	  displayName: 'DataChart',
	  renderToggleFilter: function renderToggleFilter() {
	    var options = this.props.filters.map(function (filter, i) {
	      return _react2.default.createElement(
	        'option',
	        { value: filter, key: new Date() + i },
	        filter
	      );
	    });
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { className: 'form-inline pull-right toggle-filter-container' },
	          _react2.default.createElement(
	            'fieldset',
	            ...
	            _react2.default.createElement(
	              'select',
	              { id: 'toggleFilter', className: 'form-control', onChange: this.props.toggleFilter, value: this.props.currentFilter },
	              options
	            )
	          )
	        )
	  ...
	  renderDataChartNav: function renderDataChartNav(navArray) {
	    return _react2.default.createElement(
	      'thead',
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'td',
	          { className: 'text-center th-header-link th-header-' + navArray[0], colSpan: '1' },
	          navArray[0]
	        ),
	        _react2.default.createElement(
	          'td',
	          { className: 'text-center th-header-link th-header-' + navArray[1], colSpan: '1' },
	          _react2.default.createElement(
	            'a',
	            { href: '#', onClick: this.props.toggleSort(navArray[1]) },
	            navArray[1]
	          )
	        ),
	        _react2.default.createElement(
	          'td',
	          { className: 'text-center th-header-link th-header-' + navArray[2], colSpan: '1' },
	          _react2.default.createElement(
	            'a',
	            { href: '#', onClick: this.props.toggleSort(navArray[2]) },
	            navArray[2]
	          )
	        ),
	        _react2.default.createElement(
	          'td',
	          { className: 'text-center th-header-link th-header-' + navArray[3], colSpan: '2' },
	          _react2.default.createElement(
	            'a',
	            { href: '#', onClick: this.props.toggleSort(navArray[3]) },
	            navArray[3]
	          )
	        ),
	        _react2.default.createElement(
	          'td',
	          { className: 'text-center th-header-link th-header-' + navArray[4], colSpan: '4' },
	          _react2.default.createElement(
	            'a',
	            { href: '#', onClick: this.props.toggleSort(navArray[4]) },
	            navArray[4]
	          )
	        ),
	        _react2.default.createElement(
	          'td',
	          { className: 'text-center th-header-link th-header-' + navArray[5] },
	          navArray[5]
	        ),
	        _react2.default.createElement(
	          'td',
	          { className: 'text-center th-header-link th-header-' + navArray[6] },
	          navArray[6]
	        ),
	        _react2.default.createElement(
	          'td',
	          { className: 'text-center th-header-link th-header-' + navArray[7] },
	          _react2.default.createElement(
	            'a',
	            { href: '#', onClick: this.props.toggleSort(navArray[7]) },
	            navArray[7]
	          )
	        )
	      )
	  ...
	  renderRow: function renderRow(row, i) {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'td',
	          { className: 'text-center', colSpan: '1' },
	          _react2.default.createElement(
	            'p',
	            null,
	            row.id
	        ...
	        _react2.default.createElement(
	          'td',
	          { className: 'text-center', colSpan: '4' },
	          _react2.default.createElement(
	            'p',
	            null,
	            row.description
	  ...
	  renderDataChart: function renderDataChart() {
	    var chart = null;
	    self = this;
	    if (this.props.data.length !== 0) {
	      var _chart = this.props.data;
	      return _chart.map(function (row, i) {
